<template>
  <view class="partner-wrap-mask" :class="[themeClass]">
    ...
    <view class="partner-mask-content">
      ...
      <view
        ...
        @tap="$emit('selectZuiyoujia')"
      >
        <view class="partner-logo-name">
          <view
            style="width: 64px; height: 64px; background: #ff6500; color: #fff; border-radius: 50%; font-size: 40px; text-align: center;"
          >
            惠
          </view>
        ...
        <view class="partner-item-wrap-out">
          ...
          >
            <view class="partner-item-oil">
              <view class="partner-item-oil-text">{{ item.oilName }}</view>
              <view class="partner-item-oil-text2">({{ item.partnerName }})</view>
            </view>
      ...
      <view
        ...
        @tap="$emit('selectPartner', partnerIndex)"
      >
        <view class="partner-logo-name">
        ...
        <view class="messageContainer">
          <view v-if="partnerItem.isInvoice == 1" class="fapiao"> 支持电子发票 </view>
        ...
        <view
          ...
          :class="partnerItem.couponCount > 0 || partnerItem.isInvoice == 1 ? 'partner-item-wrap-out1' : ''"
        >
          <view
            ...
            class="partner-item-wrap"
          >
            <view class="partner-item-oil">{{ priceItem.oilName }}</view>
            <view class="partner-item-price">
...
export default {
  ...
  emits: ["selectZuiyoujia", "selectPartner", "close"],
};
</script>